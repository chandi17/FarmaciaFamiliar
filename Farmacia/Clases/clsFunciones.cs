...
namespace ClassFunciones
{
    public class clsFunciones
    {
        ...
        //Metodo Encargado Validar un campo entero 
        public static bool ValidarCampoEntero(string CajaDeText)
        {
            try
            {
                int d = Convert.ToInt32(CajaDeText);
                return true;
            }
            catch (Exception )
            {
        ...
        public static void VerificarTamaño(TextBox txtPrueba)
        {
            if (txtPrueba.TextLength < 8)
            {
                MessageBox.Show("La contraseña debe tener mas de 8 digitos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }

        }
        public static void ValidaCaracteres(KeyPressEventArgs e)
        {
            if ((e.KeyChar >= 33 && e.KeyChar <= 64) || (e.KeyChar >= 91 && e.KeyChar <= 95) || (e.KeyChar >= 123 && e.KeyChar <= 126))
            {
                MessageBox.Show("Error! Caracteres no validos", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
            }
        }
        public static void ValidaInicioEspacio(TextBox txtNombre,KeyPressEventArgs e)
        {
            if (e.KeyChar == 32 && txtNombre.Text == "")
            {
        ...
        public class CreaTicket
        {
            ...
            //Metodo encargado de Imprimir un Tiket 
            ...
            //Metodo encargado de Alinear el texto a la Izquiera de la Factura
            ...
            //Metodo encargado de Alinear el texto a la Derecha de la Factura
            ...
            //Metodo encargado de Alinear el texto a la Centro de la Factura
            ...
            //Metodo encargado de Alinear el texto de los extremos de la Factura 
            ...
            //Metodo encargado de Agregar los datos calculados de la Factura
            ...
            public void AgregaArticulo(string Articulo, string precio, string cant, string subtotal)
            {
                if (cant.ToString().Length <= 3 && precio.ToString().Length <= 10 && subtotal.ToString().Length <= 11) // valida que cant precio y total esten dentro de rango
                {
                    ...
                    {
                        //cort = max - 24;
                        parte1 = Articulo.Remove(0, 15);          // corta a 16 la descripcion del articulo
                        MessageBox.Show(parte1);
            ...
            //Metodo que imprime el tiket ya completo
